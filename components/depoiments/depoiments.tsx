...
<h1 className="text-3xl font-bold mb-2">Lado a lado com a sua evolução</h1>
  ...
  {customers.map((customer) => (
                    <div key={customer.name + customer.email} className="mt-10 h-[330px] w-[340px] rounded-xl bg-black p-4 shadow-sm backdrop-blur-lg xl:w-[420px] items-center flex text-center">
